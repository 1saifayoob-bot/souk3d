...
const STORE_PRODUCTS = [
  ...
  { id: 3, name: "Palestinian Olive Tree", name_ar: "дجرة الزيتون الفلسطينية", category: "Art", country: "Palestine", flag: "🇵🇸", price: 54.99, compareAt: null, badge: null, stars: 5.0, reviews: 29, emoji: "🫒", desc: "A symbol of steadfastness and heritage. This sculptural olive tree captures the spirit of Palestinian connection to the land.", customizable: false },
...
function CustomOrderForm({ onBack }) {
  ...
  const OCCASIONS = [
    ...
    { id: "anniversary", label: "Anniversary", emoji: "💞", arabic: "ذكرى سنوية" t,
