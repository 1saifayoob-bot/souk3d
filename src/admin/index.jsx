            ...
            <div>
              ...
              <section id="pf-pricing" className="s3d-sec">
                ...
                <div style={{ marginTop: 22 }}>
                  ...
                  <div style={{ ...hint, marginTop: 0, marginBottom: 10 }}>The price change is added to the base price: 2 means +$2.00, -1.5 means $1.50 less, empty means same price. Pick a photo for a choice and the store shows that photo when a customer selects it — and a shared link can point straight at it.</div>
